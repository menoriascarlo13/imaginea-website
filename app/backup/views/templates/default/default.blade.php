...
<html>
	...
	<section class="top-header">
			...
			<ul class="sub-nav sub-nav-about">
				...
				<li class="sn-contactForm first-li inactive">
					<a href="#"> History</a>
				</li>
			</ul>
	...
	<section class="footer">
				...
				<div class="footer-wrap-a">
					<div class="footer-row-a">
						<ul>
							...
							<li>
								<a href="about_careers.html">Careers</a>
							</li>
							<li>
								<a href="#">History</a>
							</li>
					...
					<div class="footer-row-b">
						<ul>
							...
							<li>
								<a href="#">Strategy & Technology Solutions</a>
							</li>
							<li>
								<a href="#">Emerging Platform Solutions</a>
							</li>
							<li>
								<a href="#">Product Lifecycle Services</a>
							</li>
							<li>
								<a href="#">Innovation & Product Management</a>
							</li>
							<li>
								<a href="#">Technology Services for Enterprise</a>
							</li>
						</ul>
					</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
			    ...
			    /*
			     *  For handiling the ContactUs submission
			     */
