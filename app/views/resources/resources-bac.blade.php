...
@section('main-content-left') 
	...
	<p>
		Web applications today need to be more reliable than ever. Cloud applications in particular impose very specific technical requirements: high reliability,<a target="_blank" style="float: right; display: block;margin: 20px;border:1px solid #ccc;" href="/images/resources/white-papers/white paper 2.pdf"><img src="/images/resources/white-papers/whitepaper-cloud.png" /> </a> dynamic scalability and low latency across all layers. They must scale dynamically with increase in users and data volumes. Scaling poses the biggest challenge and many IT shops have responded by simply adding more resources, making this a very expensive proposition for many organizations.
	</p>
	<p>
