@extends('templates.default.default')
	...
	@section('metas')
		...
		<meta name="description" content="The story behind how Imaginea became the dedicated services company with a rich product background that it is today." />
		<meta name="keywords" content="history of imaginea, imaginea history, company history" />
	@stop

	@section('page-title')
		Imaginea - Company History
	@stop
	@section('body-tag')
		about about_landing
	@stop
