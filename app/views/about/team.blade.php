@extends('templates.default.default')
	...
	@section('main-content-left')
		...
		<ul>
			...
			<li>
				<h3>Vijay Balan</h3>
				<p><b>VP Consulting Services</b></p>
				<p>
				Vijay is experienced in driving and implementing business and technology transformations in large, multi-national organizations. He brings comprehensive enterprise wide management knowledge including working with multiple organizational levels, aligning business processes and systems, designing technology solutions, and overseeing execution of medium to large sized projects. He has over two decades of industry and tier one consulting experience with Fortune 50 and mid market companies in finance, insurance, life sciences, manufacturing and distribution, and business services sectors. Prior to joining Pramati, Vijay held various technology leadership positions at Arthur J Gallagher, GE, IBM, PWC, and Coopers & Lybrand. Vijay has an engineering degree in Computer Science from University of Madras and Master’s degree in Software Engineering from Coventry University, UK.
				</p>
			</li>
			<li>
